...
export default function WorkingGoogleLogin() {
  ...
  const handleGoogleLogin = () => {
    ...
    toast.success('Opening Google OAuth...', { icon: '🔗' })
    
    // Simple approach - just redirect to Google with basic parameters
    ...
    const googleUrl = `https://accounts.google.com/oauth/authorize?${params.toString()}`
